...
%        target_histgram=0.8*k+0.2*Estimate(loop-1).histgram;
     ...
     if(loop+first-1<10)  a=num2str(loop+first-1,'%01.1g');
     elseif(loop+first-1<100) a=num2str(loop+first-1,'%02.2g');
     elseif(loop+first-1<1000) a=num2str(loop+first-1,'%03.3g');
